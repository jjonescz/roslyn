...
";
        ...
        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/67435")]
        public void RefTemp_RefAssignment()
        {
            var source = """
        ...
        public void RefTemp_Return_01()
        {
            var source = """
                ...
                """;
            CompileAndVerify(source, expectedOutput: "111222").VerifyDiagnostics();
        }
