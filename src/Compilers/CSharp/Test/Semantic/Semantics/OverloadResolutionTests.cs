...
";
            ...
            compilation.VerifyDiagnostics(
                // (33,12): error CS8128: Member 'Rest' was not found on type 'ValueTuple<T1, T2, T3, T4, T5, T6, T7, T8>' from assembly 'comp, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null'.
                //     struct ValueTuple<T1, T2, T3, T4, T5, T6, T7, T8>
                Diagnostic(ErrorCode.ERR_PredefinedTypeMemberNotFoundInAssembly, "ValueTuple").WithArguments("Rest", "System.ValueTuple<T1, T2, T3, T4, T5, T6, T7, T8>", "comp, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null").WithLocation(33, 12));
