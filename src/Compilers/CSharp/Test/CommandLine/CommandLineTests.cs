...
");
        ...
        public void GlobalAnalyzerConfig_SuppressDiagnosticInGeneratedFiles()
        {
            ...
            var packageCs = packagesDir.CreateFile("package.cs").WriteAllText("""
                // Simulating a file from a source NuGet package.
                class D;
                """);
            ...
            var generator = new PipelineCallbackGenerator((ctx) =>
            {
                ctx.RegisterSourceOutput(ctx.ParseOptionsProvider, (spc, po) =>
                {
                    ...
                    spc.AddSource("output2.cs", """
                        // <auto-generated/>
                        class G2;
                        """);
                    spc.AddSource("output3.g.cs", "class G3;");
                });
            });
            ...
            string sectionName, int expectedWarningCount)
        {
            ...
            var generator1 = new PipelineCallbackGenerator((ctx) =>
            {
                ctx.RegisterSourceOutput(ctx.ParseOptionsProvider, (spc, po) =>
                {
                    spc.AddSource("output1.cs", "class G1_1;");
                    spc.AddSource("output2.cs", """
                        // <auto-generated/>
                        class G1_2;
                        """);
                    spc.AddSource("output3.g.cs", "class G1_3;");
                });
            });
            ...
            var generator2 = new PipelineCallbackGenerator2((ctx) =>
            {
                ctx.RegisterSourceOutput(ctx.ParseOptionsProvider, (spc, po) =>
                {
                    spc.AddSource("output1.cs", "class G2_1;");
                    spc.AddSource("output2.cs", """
                        // <auto-generated/>
                        class G2_2;
                        """);
                    spc.AddSource("output3.g.cs", "class G2_3;");
                });
            });
