...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed partial class LocalRewriter
    {
        ...
        private BoundExpression? MakeCollectionInitializer(BoundExpression? rewrittenReceiver, BoundCollectionElementInitializer initializer)
        {
            ...
            return MakeCall(null, syntax, rewrittenReceiver, addMethod, rewrittenArguments, argumentRefKindsOpt, initializer.InvokedAsExtensionMethod, receiverCloned: false, initializer.ResultKind, addMethod.ReturnType, temps.ToImmutableAndFree());
        }
