                ...
                foreach (var symbol in membersByName[name])
                {
                    ...
                    switch (symbol, prev)
                    {
                        ...
                        default:
                            ...
                            Debug.Assert(symbol is SourceOrdinaryMethodSymbol or SourcePropertySymbol or SourcePropertyAccessorSymbol or SourceConstructorSymbol or SourceEventSymbol);
                            Debug.Assert(prev is SourceOrdinaryMethodSymbol or SourcePropertySymbol or SourcePropertyAccessorSymbol or SourceConstructorSymbol or SourceEventSymbol);
                            break;
                    }
                }
