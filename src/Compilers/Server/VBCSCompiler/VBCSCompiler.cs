...
namespace Microsoft.CodeAnalysis.CompilerServer
{
    internal static class VBCSCompiler
    {
        public static int Main(string[] args)
        {
            ...
            if (!BuildServerController.ParseCommandLine(args, out var pipeName, out var shutdown, out var purgeCache, out var keepAlive, out var logFilePath))
            {
            ...
            try
            {
                ...
                return controller.Run(pipeName, shutdown, purgeCache, keepAlive);
            }
            catch (Exception e)
            {
