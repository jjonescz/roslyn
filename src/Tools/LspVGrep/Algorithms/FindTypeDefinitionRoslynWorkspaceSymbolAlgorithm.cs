...
internal sealed class FindTypeDefinitionRoslynWorkspaceSymbolAlgorithm : QueryAlgorithm<FindTypeDefinitionQuery>
{
    public override string Name => "roslyn-find-declarations-workspaceSymbol";
        ...
        CancellationToken cancellationToken)
    {
        ...
        var summary = $"called SymbolFinder.FindSourceDeclarationsWithPatternAsync(solution, '{query.Name}') without SymbolFilter";
