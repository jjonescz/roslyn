...
internal sealed class FindTypeDefinitionRoslynAlgorithm : QueryAlgorithm<FindTypeDefinitionQuery>
{
    public override string Name => "roslyn-find-declarations";
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new AlgorithmExecutionResult(
            ...
            $"called SymbolFinder.FindDeclarationsAsync(project, '{query.Name}', SymbolFilter.Type)");
    }
}
